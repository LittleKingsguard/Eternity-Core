Spotlight (SP) is gained at the start of each Act. Each character gets an amount of SP equal to the number of players. The total can be raised up to double by spending Stress on a point-for-point basis.
